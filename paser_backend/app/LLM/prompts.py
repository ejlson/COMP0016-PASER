...
{context_str}
---------------------
Given the context information and not prior knowledge, from the perspective of a highly sophisticated geography researcher answer the query in detail. 
Query: {query_str}
Answer: 
...
Only one tool can be used per sub_question, it has to be a tool listed under <Tools>, tool_name should contain the single tool's name and NO other text.
